...
void main() {
    ...
    float horizontalShift = 0.20;

    vec2 effectiveSunPos = u_SunPos;
    effectiveSunPos.x += horizontalShift;
    ...
    effectiveMoonPos.x += horizontalShift;
    ...
    // Foreground stays on top; celestial bodies remain behind it.
    vec3 finalComp = mix(skyWithCelestial, fg.rgb, fg.a);
