...
import com.adnan.lumisky.definition.UniformValueDefinition
import com.adnan.lumisky.engine.MutableRenderFrameState
import com.adnan.lumisky.engine.RenderContext
import com.adnan.lumisky.engine.gl.GlProgram
...
open class ShaderLayer(
    ...
    override fun render(frame: MutableRenderFrameState) {
        ...
        if (isOptionalLayer) {
            val enabled = frame.particleEffectsEnabled && frame.quality != com.adnan.lumisky.definition.QualityTier.LOW && !frame.thermalEmergency
            if (!enabled) return
        }
        ...
        val hasStars = if (frame.particleEffectsEnabled && frame.quality != com.adnan.lumisky.definition.QualityTier.LOW && !frame.thermalEmergency) 1f else 0f
